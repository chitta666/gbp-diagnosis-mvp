...
// ../.wrangler/tmp/bundle-J8mrm5/strip-cf-connecting-ip-header.js
...
async function onRequest(context) {
  ...
  const json = /* @__PURE__ */ __name((obj, status = 200) => new Response(JSON.stringify(obj, null, 2), { status, headers }), "json");
  if (!input)
...
// ../.wrangler/tmp/pages-yKntpC/functionsRoutes-0.5918050784402961.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-J8mrm5/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-J8mrm5/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9693832750242587.mjs.map
